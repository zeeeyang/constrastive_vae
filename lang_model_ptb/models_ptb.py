...
class Encoder(nn.Module):
    ...
    def forward(self, sents, eps):
        ...
        #or word dropout or rnn dropout??
        #tzy:
        word_vecs = self.enc_dropout(word_vecs)
        ...
        return z, enc_h_states_last.data, enc_h_states_last
    
    def obtain_latent(self, enc_h_states_last, eps):
...
class Decoder(nn.Module):
    ...
    def forward(self, sents, q_z):
        ...
        dec_input = torch.cat([self.word_vecs, q_z_expand], 2) ### tzy: combine q_z with every word
...
class RNNVAE(nn.Module):
    ...
    def _enc_forward(self, sent):
        ...
        return mean, logvar, enc_h_states_last
